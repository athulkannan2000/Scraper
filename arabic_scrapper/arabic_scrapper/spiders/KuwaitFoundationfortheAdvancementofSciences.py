...
news_sites_list,categories_english,main_category,sub_category,platform,media_type,urgency = load_dataset_lists("Kuwait Foundation for the Advancement of Sciences")
