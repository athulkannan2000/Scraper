...
news_sites_list,categories_english,main_category,sub_category,platform,media_type,urgency = load_dataset_lists("Ministry of Information")
...
class MinistryofInformationSpider(scrapy.Spider):
    ...
    def parse_page(self,response):
        ...
        yield {
                ...
                "contents": " ".join(response.xpath("//div[@class='entry-content entry clearfix']/p/span/text()").extract()+response.xpath('//*[@class="entry-content entry clearfix"]//p//span/text()').extract()+response.xpath('//*[@class="entry-content entry clearfix"]//p/text()')),
