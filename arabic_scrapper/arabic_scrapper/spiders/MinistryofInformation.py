...
class MinistryofInformationSpider(scrapy.Spider):
    ...
    def parse_page(self,response):
        ...
        yield {
                ...
                "contents": "\n\n".join(response.xpath("//div[@class='entry-content entry clearfix']/p/span/text()").extract()+response.xpath('//*[@class="entry-content entry clearfix"]//p//span/text()').extract()+response.xpath('//*[@class="entry-content entry clearfix"]//p/text()').extract()),
