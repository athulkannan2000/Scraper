...
class NazahaSpider(scrapy.Spider):
    name = 'nazaha'
    def __init__(self):
    ...
    def start_requests(self):
        for page,catagori,main_categor,sub_categor,platfor,media_typ,urgenc in zip(site_list,catagory,main_category,sub_category,platform,media_type,urgency): 
            ...
            urls=dom.xpath('//*[@class="Projects_Content_Title"]/a/@href')
            for url in urls:
                page_url=url
    ...
    def link_extractor(self,response):
        ...
        alwatan_item["title"]=str(title)
        alwatan_item["contents"]=str(contents)
        alwatan_item["image_url"]=None #no page is having image in this site
        alwatan_item["date"]=str(date)
        alwatan_item["author_name"]="NAZAHA Kuwait Anti-Corruption Authority"
