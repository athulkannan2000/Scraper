...
try:
    ...
    news_agencies_list = pd.read_csv('C:/Users/rbw19/OneDrive/Desktop/Scraper/arabic_scrapper/arabic_scrapper/spiders/News Aggregator Websites & Categories list - EN-AR - version 1 (1).xlsx - GOV and Private.csv')
